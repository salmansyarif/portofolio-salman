    ...
    <section id="about" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-8 sm:mb-12 md:mb-16"
        >
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="relative w-[280px] sm:w-[320px] md:w-[380px] lg:w-96 h-[400px] sm:h-[450px] md:h-[500px] overflow-hidden border-8 border-blue-500/30 shadow-2xl rounded-[30px] shadow-blue-500/30"
              >
                <Image
          ...
          >
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
            ...
            >
              <div className="bg-gradient-to-r from-blue-500/10 to-blue-600/10 border border-blue-500/30 rounded-lg px-3 sm:px-4 py-2">
                <span className="text-blue-400 font-semibold text-sm sm:text-base">3 Years Study</span>
              </div>
              <div className="bg-gradient-to-r from-blue-500/10 to-blue-600/10 border border-blue-500/30 rounded-lg px-3 sm:px-4 py-2">
                <span className="text-blue-400 font-semibold text-sm sm:text-base">20+ Projects</span>
              </div>
              <div className="bg-gradient-to-r from-blue-500/10 to-blue-600/10 border border-blue-500/30 rounded-lg px-3 sm:px-4 py-2">
                <span className="text-blue-400 font-semibold text-sm sm:text-base">Full Stack</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
